...
export class UI {
 ...
 <section id="welcome" class="welcome"><a class="brand" href="#" aria-label="${t("La Terreta home")}"><span class="orange-mark small"><i></i></span><span>La Terreta<span class="brand-sub">${t("A LITTLE WORLD")}</span></span></a>
